...
public class QuoteMaker extends Application {
  ...
  public void start(final Stage stage) throws Exception {
    ...
    timeline.setText("Stack");
    timeline.setStyle("-fx-text-fill: #6666ff; -fx-font: 16px 'Times New Roman';");
    timeline.setOnMouseClicked(e -> {
        hTimeline = makeTimeline();
        sc.setVisible(true);
  ...
  public void postMessageBoard(){
      ...
      System.out.println("numChildren in messageboard in postMessageBoard " + numChildren);
        ...
        sp.setOnMouseClicked(new EventHandler<MouseEvent>() {
          @Override public void handle(MouseEvent mouseEvent) {
            //System.out.println("we on sp on mouse clicked");
            selectedQuote.set(newQuote);
  ...
  class MessageBoard extends Pane {
    ...
    void post(){
        ...
        /*if(focusStack.index > 0){
            effect.get(focusStack.index-1).setScaleX(1);
            effect.get(focusStack.index-1).setTranslateY(0);
        }
        else{
            effect.get(focusStack.notecards.size()-1).setScaleX(1);
            //effect.get(focusStack.index-1).setTranslateY(0);
        }
        ...
        //hTimeline.relocate(10, 630);
        //hTimeline.setMaxWidth(300);
        //hTimeline.setPrefWidth(300);
    ...
    StackPane post(String quote, Color color) {
      ...
      sp.setOnMouseClicked(new EventHandler<MouseEvent>() {
          @Override public void handle(MouseEvent mouseEvent) {
            System.out.println("we in sp on mouse clicked");
            sp.toFront();
  ...
  public void makeTimeline(){
     ...
     focusStack.IdxProperty().addListener((ObservableValue<? extends Number> observable, Number oldValue, Number newValue) -> {
      ...
      messageBoard.getChildren().remove(scrollPane);*/
      messageBoard.post();
